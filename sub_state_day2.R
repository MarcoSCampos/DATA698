...
write.csv(sample_enem, file = "sample_enem_day2_PI.csv",row.names=FALSE)
#write.csv(sample_enem, file = "sample_enem_day2_PB.csv",row.names=FALSE)
#write.csv(sample_enem, file = "sample_enem_day2_PE.csv",row.names=FALSE)
#write.csv(sample_enem, file = "sample_enem_day2_CE.csv",row.names=FALSE)
#write.csv(sample_enem, file = "sample_enem_day2_RN.csv",row.names=FALSE)
...
head(df_day2)
write.csv(df_day2, file = "df_day2_PI.csv",row.names=FALSE)
#write.csv(df_day2, file = "df_day2_PB.csv",row.names=FALSE)
#write.csv(df_day2, file = "df_day2_PE.csv",row.names=FALSE)
#write.csv(df_day2, file = "df_day2_CE.csv",row.names=FALSE)
#write.csv(df_day2, file = "df_day2_RN.csv",row.names=FALSE)
#
#
#
#
